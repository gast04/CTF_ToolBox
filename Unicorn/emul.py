...
import capstone, r2pipe, array, unicorn
...
mu.mem_write(ADDRESS*2 - 0x10, "\xd2\x04")
mu.mem_write(ADDRESS*2 - 0x8, "\x0b\x0c") # 3083 -> 0x0C0B
mu.mem_write(ADDRESS*2 - 0x8, "\x63\x00") #   99 -> 0x0063
